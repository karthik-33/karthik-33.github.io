...
2. Certain component types (ex. CP-028 - straight adapter) are predominantly present in greater numbers in lower priced assemblies.
...
5. Feature importances from an optimized xgboost model are shown below.
